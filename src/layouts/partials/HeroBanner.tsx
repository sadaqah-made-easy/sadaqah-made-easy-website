...
const HeroBanner = ({ banner }: any) => {
  const { title, content, image, button, google_play, weekly_active_users, last_month_donation, last_month_shares } = banner;
  return (
    <div className="headerBg -mt-[102px] relative z-40">
            ...
            <div className="col-11">
              <div className="row justify-center lg:justify-between">
                <div className="lg:col-7 order-2 lg:order-1">
                  <h1 className="font-medium text-dark" dangerouslySetInnerHTML={markdownify(title)} />
                  <p className="text-2xl text-dark mt-2 mb-4" dangerouslySetInnerHTML={markdownify(content)} />
                  <div className="flex items-center gap-6">
                    {
                      button.enable && (
                        <a href={button.link} className="btn btn-primary py-1 px-3 -mb-5 font-normal text-base">
                  ...
                  <div className="grid sm:grid-cols-3 mt-14 text-[12px] gap-6 lg:gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-bold" dangerouslySetInnerHTML={markdownify(weekly_active_users)} />
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <Image
                      ...
                      <div>
                        ...
                        <p className="font-bold" dangerouslySetInnerHTML={markdownify(last_month_donation)} />
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <Image
                      ...
                      <div>
                        ...
                        <p className="font-bold" dangerouslySetInnerHTML={markdownify(last_month_shares)} />
                      </div>
                    </div>
                  </div>
                </div>
